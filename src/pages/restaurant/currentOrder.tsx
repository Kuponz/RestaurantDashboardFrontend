          ...
          >
            ...
            >
              ...
              <ToggleButtonGroup
                ...
                aria-label="Platform"
              >
                <ToggleButton value="incomingOrders">
                  Incoming Orders
                </ToggleButton>
                <ToggleButton value="completedOrders">
                  Completed Orders
                </ToggleButton>
              </ToggleButtonGroup>
            ...
            {isLoading ? (
              ...
              >
                {alignment == "incomingOrders" ? (
                  order?.incomingOrders?.length != 0? 
                  order?.incomingOrders?.map((runningOrder) => (
                    <OrderContainer
                      userDetails={userDetails}
                      key={runningOrder._id}
                      order={runningOrder}
                    />
                  ))
                  :
